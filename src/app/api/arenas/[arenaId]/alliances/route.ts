...
/**
 * GET /api/arenas/[arenaId]/alliances
 * Returns the current user's alliance state: myAlliance + incomingProposals.
 */
export async function GET(
  ...
  const res = await fetch(
    `${ENGINE_URL}/internal/alliances/${arenaId}/${participant.id}`,
