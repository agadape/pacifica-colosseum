...
const CATEGORY_STYLES = {
  aggressive: {
    ...
    selectedBorder: "border-neon-magenta",
    badge: "bg-neon-magenta/20 text-neon-magenta",
    btn: "bg-neon-magenta hover:bg-neon-magenta/80",
  ...
  defensive: {
    ...
    selectedBorder: "border-neon-cyan",
    badge: "bg-neon-cyan/20 text-neon-cyan",
    btn: "bg-neon-cyan hover:bg-neon-cyan/80",
  ...
  scout: {
    ...
    selectedBorder: "border-neon-gold",
    badge: "bg-neon-gold/20 text-neon-gold",
    btn: "bg-neon-gold hover:bg-neon-gold/80",
    glow: "shadow-neon-gold/20",
    label: "Scout",
  },
};
