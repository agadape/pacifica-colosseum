    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-1.5">
          ...
          {myCell.isEliminationZone && (
            <span className="text-[9px] font-semibold text-rose-600 uppercase tracking-wider bg-rose-100 px-1.5 py-0.5 rounded-full">
              Danger
            </span>
          )}
        </div>
      ...
      <div className="space-y-1.5">
        {hasBonus && (
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-text-tertiary">PnL Bonus</span>
        ...
        {hasBuffer && (
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-text-tertiary">DD Buffer</span>
        ...
        {hasCap && (
          <div className="flex items-center justify-between">
            <span className="text-[10px] text-text-tertiary">Max Leverage</span>
        ...
        {!hasBonus && !hasBuffer && !hasCap && (
          <p className="text-[10px] text-text-tertiary italic">No modifiers — base rules apply</p>
        )}
      </div>

      {myCell.isEliminationZone && (
        <div className="rounded-lg bg-rose-50 border border-rose-200/60 px-3 py-2">
          <p className="text-[10px] text-rose-700 font-semibold">⚠ Elimination zone</p>
